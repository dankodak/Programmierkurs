...
\begin {equation}
\mathcal{N} (x,\mu,\sigma) = \frac{1}{\sqrt{2\pi\sigma^{2}}}\,() exp\,{}\bigg(-\frac{(x-\mu)^{2}
{2\sigma^{2}}\bigg)
\end{equation}
wird mit dem Erwartungswert $\mu \,{} \varepsilon \,{} \mathbb{R}$ und der Varianz $\sigma^{2} > 0$
parametrisiert. IN\\
...
\caption{Die Gauß-Verteilung aus (1) für$(\mu,\sigma) \,() \{(0,0.2),(0,1),(0,5),(-2,0.5)\}$}
\label {latex_logo}
\end{center}
\end{figure}
\end{document}